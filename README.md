...
source distribution for FLAC 1.5.0 and [libiconv 1.19][2].
...
to generate the credentials needed to sign and notarize.  The [GitHub CLI][6] is
...
[7]: https://github.com/donmccaughey/flac_pkg/blob/master/Makefile
...
package is written into the project root with the name `flac-1.5.0-r2.pkg`.
...
if notarization succeeds.  Use the command:
        ...
        $ xcrun stapler validate --verbose flac-1.5.0-r2.pkg
...
site][11].  After the key is created, get the _Issuer ID_ (a UUID), the _Key
